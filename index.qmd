...
![](images/family-distribution.png){fig-align="center" width="393"}

Since species distributions for tree species in this study are not readily available, I will be comparing species from lineages with wide versus narrow distributions. Distribution estimates were based off of reports from the [Global Biodiversity Information Facility (GBIF)](https://www.gbif.org/).
